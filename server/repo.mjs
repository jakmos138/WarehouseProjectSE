...
const conf = {
  connectionString: `Driver={ODBC Driver 18 for SQL Server};Server=Z3A7-N2F7\\SQLEXPRESS;Database=WarehouseSE;Trusted_Connection=Yes;TrustServerCertificate=Yes;`
};
...
const repo = new Repo();
const errorHandling = repo.errorHandling;



export { repo, errorHandling };